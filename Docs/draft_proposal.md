...
## Developing Model
My plan is to use Logistic regression and Random tree classifier as first classification models and choose next models based on results. I will try at least two more other classifiers. My main objective of my project is to identify common risk factor of stroke.
